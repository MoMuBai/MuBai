...
public class BrokenLineCusVisitView2 extends View {
    ...
    public BrokenLineCusVisitView2(Context context) {
        super(context);
    }

    public BrokenLineCusVisitView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        inite(context);
    }
